        ...
        <nav class="navbar">
            <div class="navbar-container">
                ...
                <ul class="nav-menu" id="nav-menu">
                    <li class="nav-item"><a href="index.php" class="nav-middel">Home</a></li>
                    <li class="nav-item"><a href="aboutme.php" class="nav-middel">About Me</a></li>
                    <li class="nav-item"><a href="service.php" class="nav-middel">Services</a></li>
                    <li class="nav-item"><a href="projects.php" class="nav-middel">Projects</a></li>
                    <li class="nav-item"><a href="contact.php" class="nav-middel">Contact</a></li>
