...
<head>
    ...
    <body>
        ...
        <div class="hero-text aos-init aos-animate" data-aos="fade-right">
            <h1>Welcome to my Universe</h1>
            <p>I am Muhammad Alothman, a developer crafting digital experiences.</p>
            <a href="projects.php" class="btn">Explore My Work</a>
        </div>
