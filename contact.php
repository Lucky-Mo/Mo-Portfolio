...
<div class="relative p-5 lg:px-20 flex flex-col md:flex-row items-center justify-center">
    ...
    <div class="bg-gray-900 border border-red-500 w-full lg:w-1/2 h-full p-5 pt-8">
        ...
        <a href="https://github.com/Lucky-Mo" class="flex items-center hover:text-white hover:bg-red-500 p-2">
        ...
        <a href="https://www.linkedin.com/in/muhammad-alothman-2155252b0" class="flex items-center hover:text-white hover:bg-red-500 p-2">
        ...
        <a href="https://www.instagram.com/mootje_othman/" class="flex items-center hover:text-white hover:bg-red-500 p-2">
            <svg fill="currentColor" class="w-6 h-6 m-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.17.056 1.97.24 2.427.403.59.214 1.01.47 1.452.912.442.442.698.862.912 1.452.163.457.347 1.257.403 2.427.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.056 1.17-.24 1.97-.403 2.427-.214.59-.47 1.01-.912 1.452-.442.442-.862.698-1.452.912-.457.163-1.257.347-2.427.403-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.17-.056-1.97-.24-2.427-.403-.59-.214-1.01-.47-1.452-.912-.442-.442-.698-.862-.912-1.452-.163-.457-.347-1.257-.403-2.427C2.175 15.747 2.163 15.367 2.163 12s.012-3.584.07-4.85c.056-1.17.24-1.97.403-2.427.214-.59.47-1.01.912-1.452.442-.442.862-.698 1.452-.912.457-.163 1.257-.347 2.427-.403C8.416 2.175 8.796 2.163 12 2.163z"/>
              <path d="M12 5.838a6.162 6.162 0 1 1 0 12.324 6.162 6.162 0 0 1 0-12.324z"/>
              <path d="M12 16a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/>
              <circle cx="18.406" cy="5.594" r="1.44"/>
            </svg>
            Instagram
        </a>
        <a href="https://www.facebook.com/mohammad.othman.06/" class="flex items-center hover:text-white hover:bg-red-500 p-2">
            <svg fill="currentColor" class="w-6 h-6 m-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
